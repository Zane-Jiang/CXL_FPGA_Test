...
--------------------
   ...
   PHY_FPGA_SPEEDGRADE_GUI                           : E2V (ES2) - change device under 'View'->'Device Family'
   PHY_TARGET_SPEEDGRADE                             : E2V
   PHY_TARGET_IS_ES                                  : false
   PHY_TARGET_IS_ES2                                 : true
