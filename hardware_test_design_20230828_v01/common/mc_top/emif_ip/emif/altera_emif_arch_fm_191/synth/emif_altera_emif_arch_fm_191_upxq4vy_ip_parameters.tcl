...
set ::GLOBAL_emif_altera_emif_arch_fm_191_upxq4vy_corename emif_altera_emif_arch_fm_191_upxq4vy
...
set var(tQH)                                                     0.43
set var(tDS)                                                     0.04583333333333334
set var(tDH)                                                     0.04583333333333334
set var(tIS)                                                     0.055
set var(tIH)                                                     0.08
set var(tDQSCK)                                                  0.17
set var(tDQSS)                                                   0.27
...
set var(RD_ISI)                                                  0.155
set var(WR_ISI)                                                  0.16
set var(CA_ISI)                                                  0.15
set var(DQSG_ISI)                                                0.15
set var(WL_ISI)                                                  0.078
set var(X4)                                                      0
set var(IS_DLL_ON)                                               1
set var(OCT_RECAL)                                               1
set var(RDBI)                                                    1
...
set var(PATTERNS_AC_SYNC)                                        [list arch|arch_inst|bufs_inst|gen_mem_a.inst[0].b|cal_oct.obuf|o \
                                                                       ...
                                                                       arch|arch_inst|bufs_inst|gen_mem_cke.inst[1].b|cal_oct.obuf|o \
                                                                       ...
                                                                       arch|arch_inst|bufs_inst|gen_mem_odt.inst[1].b|cal_oct.obuf|o \
