...
source "$script_dir/emif_altera_emif_arch_fm_191_szs75py_report_timing_core.tcl"


if [ info exists ddr_db ] {
   unset ddr_db
}
emif_altera_emif_arch_fm_191_szs75py_initialize_ddr_db ddr_db var
...
foreach inst $instances {
   ...
   if {[llength $instances] <= 1} {
      set fbasename "${::GLOBAL_emif_altera_emif_arch_fm_191_szs75py_corename}"
   } else {
      set fbasename "${::GLOBAL_emif_altera_emif_arch_fm_191_szs75py_corename}_${inst_id}"
   }
   ...
   emif_altera_emif_arch_fm_191_szs75py_perform_core_analysis $opcname $inst pins var summary

   #######################################
   # Print out the Summary Panel for this instance

   set summary [lsort -command emif_altera_emif_arch_fm_191_szs75py_sort_proc $summary]

   post_message -type info "Core: ${::GLOBAL_emif_altera_emif_arch_fm_191_szs75py_corename} - Instance: $inst"
   ...
   foreach summary_line $summary {
      ...
      if {$su != "--"} {
         set su [ emif_altera_emif_arch_fm_191_szs75py_round_3dp $su]
      }
      if {$hold != "--"} {
         set hold [ emif_altera_emif_arch_fm_191_szs75py_round_3dp $hold]
      }
