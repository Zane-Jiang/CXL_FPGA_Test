...
module emif (
	...
	emif_altera_emif_fm_262_ph4wewq emif (
		...
		.mem_cke              (mem_cke),              //  output,     width = 2,                   .mem_cke
		.mem_cs_n             (mem_cs_n),             //  output,     width = 2,                   .mem_cs_n
		.mem_odt              (mem_odt),              //  output,     width = 2,                   .mem_odt
		...
		.amm_address_0        (amm_address_0),        //   input,    width = 28,                   .address
