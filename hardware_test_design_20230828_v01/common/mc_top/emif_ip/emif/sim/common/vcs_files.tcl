...
namespace eval emif {
  ...
  proc get_design_files {QSYS_SIMDIR} {
    set design_files [dict create]
    dict set design_files "emif_altera_emif_arch_fm_191_szs75py_top.sv" "$QSYS_SIMDIR/../altera_emif_arch_fm_191/sim/emif_altera_emif_arch_fm_191_szs75py_top.sv"
    ...
    dict set design_files "emif_altera_emif_arch_fm_191_szs75py.sv"     "$QSYS_SIMDIR/../altera_emif_arch_fm_191/sim/emif_altera_emif_arch_fm_191_szs75py.sv"    
    dict set design_files "emif_altera_emif_fm_262_ak4gd5i.v"           "$QSYS_SIMDIR/../altera_emif_fm_262/sim/emif_altera_emif_fm_262_ak4gd5i.v"               
