...
# ----------------------------------------
# ACDS 22.4 94 linux 2022.12.21.09:45:09
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [intel_reset_release::get_memory_files "$QSYS_SIMDIR"]]
...
set logical_libraries [list "work" "work_lib" "altera_ver" "lpm_ver" "sgate_ver" "altera_mf_ver" "altera_lnsim_ver" "tennm_ver" "tennm_hssi_ver" "tennm_hssi_f0_ver" "tennm_hssi_r1_ver"]
...
alias com {
  ...
  set design_files [concat $design_files [intel_reset_release::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
