...
alias file_copy {
  ...
  set memory_files [concat $memory_files [bbs_slave::get_memory_files "$QSYS_SIMDIR"]]
...
alias com {
  ...
  set design_files [concat $design_files [bbs_slave::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
