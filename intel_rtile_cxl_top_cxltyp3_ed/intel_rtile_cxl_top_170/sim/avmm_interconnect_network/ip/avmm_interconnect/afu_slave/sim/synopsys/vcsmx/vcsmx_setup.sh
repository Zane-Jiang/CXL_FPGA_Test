...
set files [list]
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set files [concat $files [afu_slave::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
