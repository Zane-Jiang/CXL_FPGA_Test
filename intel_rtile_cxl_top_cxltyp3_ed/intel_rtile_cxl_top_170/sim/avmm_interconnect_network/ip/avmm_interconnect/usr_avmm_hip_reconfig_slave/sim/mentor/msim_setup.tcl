...
# ----------------------------------------
# If usr_avmm_hip_reconfig_slave is one of several IP cores in your
...
# ----------------------------------------
# ACDS 22.4 94 linux 2022.12.21.09:43:49
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "usr_avmm_hip_reconfig_slave.usr_avmm_hip_reconfig_slave"
}
...
append ELAB_OPTIONS [subst [usr_avmm_hip_reconfig_slave::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [usr_avmm_hip_reconfig_slave::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [usr_avmm_hip_reconfig_slave::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [usr_avmm_hip_reconfig_slave::normalize_path "$file"]
  set normalized_dest [usr_avmm_hip_reconfig_slave::normalize_path "$dest_file"]
...
set design_libraries [dict merge $design_libraries [usr_avmm_hip_reconfig_slave::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [usr_avmm_hip_reconfig_slave::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [usr_avmm_hip_reconfig_slave::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
