...
# ----------------------------------------
# If avmm_interconnect is one of several IP cores in your
...
# ----------------------------------------
# ACDS 22.4 94 linux 2022.12.21.09:43:44
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "avmm_interconnect.avmm_interconnect"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/home/tools/intelFPGA_pro/22.4/quartus/"
}
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [avmm_interconnect::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
if {[dict size $LD_LIBRARY_PATH] !=0 } {
  set LD_LIBRARY_PATH [subst [join [dict keys $LD_LIBRARY_PATH] ":"]]
  setenv LD_LIBRARY_PATH "$LD_LIBRARY_PATH"
}
append ELAB_OPTIONS [subst [avmm_interconnect::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [avmm_interconnect::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [avmm_interconnect::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [avmm_interconnect::normalize_path "$file"]
  set normalized_dest [avmm_interconnect::normalize_path "$dest_file"]
...
set logical_libraries [list "work" "work_lib" "altera_ver" "lpm_ver" "sgate_ver" "altera_mf_ver" "altera_lnsim_ver" "tennm_ver" "tennm_hssi_ver" "tennm_hssi_f0_ver" "tennm_hssi_r0_ver" "altera" "lpm" "sgate" "altera_mf" "altera_lnsim" "tennm" "tennm_hssi"]
...
if [string is false -strict [modelsim_ae_select $FORCE_MODELSIM_AE_SELECTION]] {
  ...
  ensure_lib                   ./libraries/tennm_hssi_f0_ver/
  vmap       tennm_hssi_f0_ver ./libraries/tennm_hssi_f0_ver/
  ensure_lib                   ./libraries/tennm_hssi_r0_ver/
  vmap       tennm_hssi_r0_ver ./libraries/tennm_hssi_r0_ver/
...
set design_libraries [dict merge $design_libraries [avmm_interconnect::get_design_libraries]]
...
alias dev_com {
  ...
  if [string is false -strict [modelsim_ae_select $FORCE_MODELSIM_AE_SELECTION]] {
    ...
    eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                                                                       "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctf_hssi_atoms.sv"                -work tennm_hssi_f0_ver
    eval  vlog -sv -suppress 7070,2244,2388,12003 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                                        "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctf_hssi_atoms_ncrypt.sv"         -work tennm_hssi_f0_ver
    eval  vlog -sv -suppress 7070,2244,2388,12003 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                                        "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctf_hssi_atoms2_ncrypt.sv"        -work tennm_hssi_f0_ver
    eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                                                                       "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctr_hssi_atoms.sv"                -work tennm_hssi_r0_ver
    eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                                                                       "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctr_hssi_atoms_ncrypt.sv"         -work tennm_hssi_r0_ver
    eval  vlog -sv -suppress 12003,2388,2244,2902,7033,13276,13388,7061 +define+rnra_one_lib_CXL_TOP_OFF $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctra_hssi_atoms_ncrypt.sv"        -work tennm_hssi_r0_ver
...
alias com {
  ...
  set design_files [dict merge [avmm_interconnect::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [avmm_interconnect::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
