...
TOP_LEVEL_NAME="avmm_interconnect.avmm_interconnect"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="/home/tools/intelFPGA_pro/22.4/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
set ELAB_OPTIONS ""
append ELAB_OPTIONS [avmm_interconnect::get_elab_options $SIMULATOR_TOOL_BITNESS]
puts "ELAB_OPTIONS+=\"$ELAB_OPTIONS\""
set SIM_OPTIONS ""
append SIM_OPTIONS [avmm_interconnect::get_sim_options $SIMULATOR_TOOL_BITNESS]
...
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set libraries [dict merge $libraries [avmm_interconnect::get_design_libraries]]
...
mkdir -p ./libraries/tennm_hssi_f0_ver/
mkdir -p ./libraries/tennm_hssi_r0_ver/
...
if [ $SKIP_DEV_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctf_hssi_atoms.sv"                  -work tennm_hssi_f0_ver
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$QUARTUS_INSTALL_DIR/eda/sim_lib/synopsys/ctf_hssi_atoms_ncrypt.sv"  -work tennm_hssi_f0_ver
  vlogan +v2k -sverilog +define+QUARTUS_ENABLE_DPI_FORCE $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/eda/sim_lib/synopsys/ctf_hssi_atoms2_ncrypt.sv" -work tennm_hssi_f0_ver
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctr_hssi_atoms.sv"                  -work tennm_hssi_r0_ver
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctr_hssi_atoms_ncrypt.sv"           -work tennm_hssi_r0_ver
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctra_hssi_atoms_ncrypt.sv"          -work tennm_hssi_r0_ver
...
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set design_files [dict merge $design_files [avmm_interconnect::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set files [concat $files [avmm_interconnect::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
