// avmm_interconnect_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1923_5rwtq5i.v

// Generated using ACDS version 22.4 94

`timescale 1 ps / 1 ps
module avmm_interconnect_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1923_5rwtq5i #(
		parameter SYMBOLS_PER_BEAT = 1,
		parameter BITS_PER_SYMBOL  = 116,
	...
	avmm_interconnect_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (in_data),           //   input,  width = 116,          .data
		...
		.out_data          (out_data),          //  output,  width = 116,          .data
