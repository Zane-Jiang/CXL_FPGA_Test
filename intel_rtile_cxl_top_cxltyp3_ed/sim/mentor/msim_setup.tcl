...
# ----------------------------------------
# If intel_rtile_cxl_top_cxltyp3_ed is one of several IP cores in your
...
# ----------------------------------------
# ACDS 22.4 94 linux 2022.12.21.09:44:10
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "intel_rtile_cxl_top_cxltyp3_ed.intel_rtile_cxl_top_cxltyp3_ed"
}
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [intel_rtile_cxl_top_cxltyp3_ed::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
if {[dict size $LD_LIBRARY_PATH] !=0 } {
  set LD_LIBRARY_PATH [subst [join [dict keys $LD_LIBRARY_PATH] ":"]]
  setenv LD_LIBRARY_PATH "$LD_LIBRARY_PATH"
}
append ELAB_OPTIONS [subst [intel_rtile_cxl_top_cxltyp3_ed::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [intel_rtile_cxl_top_cxltyp3_ed::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [intel_rtile_cxl_top_cxltyp3_ed::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [intel_rtile_cxl_top_cxltyp3_ed::normalize_path "$file"]
  set normalized_dest [intel_rtile_cxl_top_cxltyp3_ed::normalize_path "$dest_file"]
...
set logical_libraries [list "work" "work_lib" "altera_ver" "lpm_ver" "sgate_ver" "altera_mf_ver" "altera_lnsim_ver" "tennm_ver" "tennm_hssi_ver" "tennm_hssi_f1_ver" "tennm_hssi_r1_ver"]
...
set design_libraries [dict merge $design_libraries [intel_rtile_cxl_top_cxltyp3_ed::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [intel_rtile_cxl_top_cxltyp3_ed::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [intel_rtile_cxl_top_cxltyp3_ed::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
