...
TOP_LEVEL_NAME="intel_rtile_cxl_top_cxltyp3_ed.intel_rtile_cxl_top_cxltyp3_ed"
QSYS_SIMDIR="./../../"
...
set ELAB_OPTIONS ""
append ELAB_OPTIONS [intel_rtile_cxl_top_cxltyp3_ed::get_elab_options $SIMULATOR_TOOL_BITNESS]
puts "ELAB_OPTIONS+=\"$ELAB_OPTIONS\""
set SIM_OPTIONS ""
append SIM_OPTIONS [intel_rtile_cxl_top_cxltyp3_ed::get_sim_options $SIMULATOR_TOOL_BITNESS]
...
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set libraries [dict merge $libraries [intel_rtile_cxl_top_cxltyp3_ed::get_design_libraries]]
...
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set design_files [dict merge $design_files [intel_rtile_cxl_top_cxltyp3_ed::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set files [concat $files [intel_rtile_cxl_top_cxltyp3_ed::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
